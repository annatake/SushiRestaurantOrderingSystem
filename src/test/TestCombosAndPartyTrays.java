...
public class TestCombosAndPartyTrays {
    ...
    private Sushi s1 = new Sushi(5.00, "Roll 1");
    private Sushi s2 = new Sushi(4.00, "Roll 2");
    private Sushi s3 = new Sushi(3.00, "Roll 3");

    @Test
    public void testSetBrownRiceOneRoll() {
        testCombo = new ComboAndPartyTray(10.00, "Combo X", s1);
    ...
    public void testSetBrownRiceTwoRolls() {
        testCombo = new ComboAndPartyTray(10.00, "Combo Y", s1, s2);
        testCombo.setBrownRice(true);
        // should be $10 + $2
        assertTrue(testCombo.isBrownRice());
    ...
    public void testSetBrownRiceThreeRolls() {
        testCombo = new ComboAndPartyTray(10.00, "Combo Y", s1, s2, s3);
        testCombo.setBrownRice(true);
        // should be $10 + $3
        assertTrue(testCombo.isBrownRice());
